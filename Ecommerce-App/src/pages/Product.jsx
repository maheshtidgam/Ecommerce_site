  ...
  return productData ? (
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col gap-4 my-8">
            ...
            <div className="text-sm text-gray-500 flex flex-col gap-1">
              ...
              <p className="">Easy return exchange policy within 7 days.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
        <p className="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae corrupti voluptates, repudiandae ipsam nam culpa reprehenderit maiores fuga asperiores tenetur delectus illo molestiae quasi, repellat ipsa blanditiis ab iste rerum?</p>
