...
const Collections = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 pt-10 border-t">
      ...
      {/* ===== LEFT SIDE FILTER ===== */}
      <div className="min-w-60 bg-white p-4 rounded-xl shadow-sm border border-gray-200">
        <p
          onClick={() => setShowFilter(!showFilter)}
          className="my-2 text-xl flex items-center justify-between cursor-pointer font-semibold text-gray-800"
        >
          FILTERS
          <img
        ...
        {/* Category Section */}
        <div className={`${showFilter ? '' : 'hidden'} sm:block mt-5`}>
          <p className="text-sm font-medium text-gray-700 mb-3 border-b border-gray-200 pb-2">CATEGORIES</p>
        ...
        {/* Subcategory Section */}
        <div className={`${showFilter ? '' : 'hidden'} sm:block mt-8`}>
          <p className="text-sm font-medium text-gray-700 mb-3 border-b border-gray-200 pb-2">TYPES</p>
          <div className="flex flex-col gap-3 text-sm text-gray-600">
